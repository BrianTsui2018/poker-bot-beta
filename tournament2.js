...
let commonTextCards = [];                           //For textbase card backups. 
...
const dataRouter = (data) => {
    if (data.type === 'setup') {
        ...
        commonCardsFromGameState = t.gamestate.deck.slice(0, 5); //slices off card objects and process ahead of time!
        commonTextCards = [...commonCardsFromGameState] //cloning them to data.
        ...
        data.sidepots = t.gamestate.sidepots;
        data.minBet = t.gamestate.sb * 2;
        data.textCards = commonTextCards
